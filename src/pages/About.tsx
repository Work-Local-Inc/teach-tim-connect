...
import { GraduationCap, Users, Award, BookOpen, CheckCircle, Calendar, MapPin, Mail, Lightbulb, Target, Star } from "lucide-react";
const About = () => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2 flex justify-center relative">
              <div className="relative">
                ...
                <div className="absolute -top-4 -right-4 bg-white/20 backdrop-blur-sm rounded-full p-3 animate-bounce" style={{
                animationDelay: '0.3s'
              }}>
                  <GraduationCap className="h-6 w-6 text-white" />
                </div>
                <div className="absolute -bottom-2 -left-4 bg-white/20 backdrop-blur-sm rounded-full p-3 animate-bounce" style={{
                animationDelay: '1.2s'
              }}>
                  <Users className="h-6 w-6 text-white" />
                </div>
                <div className="absolute top-1/2 -right-8 bg-white/20 backdrop-blur-sm rounded-full p-2 animate-bounce" style={{
                animationDelay: '2.1s'
              }}>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-12">
              ...
              <div className="space-y-6">
                ...
                <div className="prose prose-lg max-w-none text-muted-foreground space-y-4">
                  <p>Teaching isn't just what I do—it's who I am. For over 20 years, I've had the privilege of helping people discover their potential and achieve their goals through education and training.</p>
                  <p>
              ...
              <div className="space-y-6">
                ...
                }].map((item, index) => <div key={index} className="border-l-4 border-primary pl-6 pb-6">
              ...
              <div className="space-y-6">
                ...
                }].map((principle, index) => <Card key={index} className="border-0 shadow-soft">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {["Decades of hands-on teaching experience across multiple industries", "Proven ability to work with diverse age groups from elementary to post-retirement", "Expertise in both technical subjects and soft skills development", "Track record of success in both public and private sector training", "Passion for connecting with students and making learning enjoyable", "Continuous professional development and certification maintenance", "Flexible teaching approaches adapted to adult learning principles"].map((point, index) => <div key={index} className="flex items-start space-x-3">
            ...
            <div className="space-y-8">
              ...
              <Card className="border-0 shadow-soft">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    {["Master Instructor Certification", "Technical Training Specialist", "Adult Education Credential", "Corporate Training Certified", "Safety Training Instructor", "Communication Skills Trainer"].map((cert, index) => <div key={index} className="flex items-center space-x-2">
              ...
              {/* Contact CTA */}
              <LeadCaptureForm title="Work With Tim" description="Ready to start your learning journey? Let's discuss your training needs." variant="compact" />
            </div>
          </div>
        </div>
      </section>
